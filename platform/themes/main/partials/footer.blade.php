            ...
            <div class="footer-wrap container-remake">
                <div class="footer-left">
                    <a href="{{ route('public.single') }}" class="logo-bottom">
                        <img loading="lazy" src="{{ get_image_url(theme_option('logo_footer')) }}"
                            alt="{!! __('THACO AUTO') !!}" height="34">
                    </a>
                    <div class="thaco-contact">
                        ...
                        <p class="address font-pri font18">
                            ...
                            <span>{!! theme_option('address-company') !!} <a href="{!! theme_option('map-company') !!}"
                                    target="_blank" `rel="noopener">({{__("Find location") }})</a></span>
                        </p>
                ...
                <div class="footer-right">
                    <div class="item">
                        <h2 class="title font-pri-bold font30 color-gray fontmb-medium" id="menu-footer">{{__('Introduce')}}
                        </h2>
                    ...
                    <div class="item">
                        ...
                        <ul class="font-pri font18 list-link">
                            <li class="color-gray phone ct-pl"><span>{{ __("Hotline") }}: </span><span><a
                                        href="tel:{{ theme_option('hotline-contact') }}"
                                        class="color-gray">{{ theme_option('hotline-contact') }}</a></span></li>
                            <li class="color-gray email ct-pl"><span>{{ __("Email") }}: </span><span><a
                                        href="mailto:{{ theme_option('email-contact') }}"
                                        class="color-gray">{{ theme_option('email-contact') }}</a></span></li>
                            <li class="color-gray fax ct-pl"><span>{{ __("Fax") }}: </span><span><a
                                        href="tel:{{ theme_option('fax-contact') }}"
                                        class="color-gray">{{ theme_option('fax-contact') }}</a></span></li>
                        </ul>
                    </div>
                    <div class="item mobile">
                        <h2 class="title font-pri-bold font30 color-gray fontmb-medium" id="menu-footer">
                            {{__('information privacy policy')}}</h2>
        ...
        <div class="action-button">
            <div class="item-button">
                <a href="tel:{{ theme_option('hotline-contact') }}"><img loading="lazy"
                        src="{{ Theme::asset()->url('images/main/phone.png') }}" alt="phone"></a>
            </div>
            <div class="item-button ">
                <button class="fb-customerchat messenger d-none"><img loading="lazy"
                        src="{{ Theme::asset()->url('images/main/mess.png') }}" alt="Messenger"></button>
            </div>
        </div>
        ...
        @if (theme_option('facebook_chat_enabled', 'yes') == 'yes' && theme_option('facebook_page_id'))
            <div class="fb-customerchat" attribution="install_email" page_id="{{ theme_option('facebook_page_id') }}"
                theme_color="{{ theme_option('primary_color', '#01498b') }}" greeting_dialog_display="fade"
