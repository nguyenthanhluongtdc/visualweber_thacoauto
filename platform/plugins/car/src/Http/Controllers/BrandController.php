...
use Exception;
use Platform\Car\Tables\BrandTable;
use Platform\Base\Events\CreatedContentEvent;
use Platform\Base\Events\DeletedContentEvent;
use Platform\Base\Events\UpdatedContentEvent;
use Platform\Base\Http\Responses\BaseHttpResponse;
use Platform\Car\Forms\BrandForm;
...
class BrandController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('plugins/car::brand.name'));
    ...
    {
        page_title()->setTitle(trans('plugins/car::brand.create'));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('plugins/car::brand.edit') . ' "' . $brand->name . '"');
