<section class="section-cultural-behavior">
    <div class="container-remake">
        <div class="cultural-behavior">
            <div class="cultural-behavior__info">
                <h2 class="cultural-behavior__title font60 font-pri-bold">VĂN HÓA ỨNG XỬ</h2>
                <div class="cultural-behavior__content font20 font-pri">
            ...
            <div class="cultural-behavior__image">
                <img src="{{Theme::asset()->url('images/cultural/cultural-behavior.jpg')}}" alt="">
            </div>
        </div>
    </div>
</section>