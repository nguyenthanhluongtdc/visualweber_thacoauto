        ...
        <div class="pre-order-content row">
            <div class="pre-order-content__left col-sm-12 col-md-12">
                ...
                <div class="select-promotions">
                    <h3 class="select-promotions__title font18 font-cond-bold">CHỌN CHƯƠNG TRÌNH KHUYẾN MÃI</h3>
                    ...
                    <div class="select-deposit__list">
                        ...
                        <div class="select-deposit__item">
                            <div class="custom-control mt-1 span-2 d-flex align-center custom-checkbox my-1 mr-sm-2">
                                ...
                                <label class="custom-control-label font15 font-pri" for="customControlInline5">Đặt cọc giá bán lẻ 50tr</label>
                            </div>
                            <div class="select-deposit_desc font-pri font15">
                                <p>Mức đặt cọc 50.000.000 VNĐ/Xe.<br>
                                    Khách hàng được chuyển nhượng/chuyển giao, chấm dứt Thỏa thuận đặt cọc và rút lại Tiền Đặt Cọc theo quy trình và hướng dẫn của KIA.
                ...
                <div class="car-selected">
                    ...
                    <ul class="specifications__list">
                        <li class="specifications__item">
                            ...
                            <span class="specifications__specification font15 font-pri">4.855 x 1.860 x 1.465 mm</span>
                        </li>
                        <li class="specifications__item">
                            <span class="specifications__name font15 font-pri">Chiều dài cơ sở</span>
                            <span class="specifications__specification font15 font-pri">2.805 mm</span>
                        </li>
                        <li class="specifications__item">
                            <span class="specifications__name font15 font-pri">Khoảng sáng gầm xe</span>
                            <span class="specifications__specification font15 font-pri">150 mm</span>
                        </li>
                        <li class="specifications__item">
                            <span class="specifications__name font15 font-pri">Bán kính quay vòng</span>
                            <span class="specifications__specification font15 font-pri">5.450 mm</span>
                        </li>
                        <li class="specifications__item">
                            <span class="specifications__name font15 font-pri">Trọng lượng Không tải</span>
                            <span class="specifications__specification font15 font-pri">1.450 kg</span>
                        </li>
                        <li class="specifications__item">
                            <span class="specifications__name font15 font-pri">Trọng lượng Toàn tải</span>
                            <span class="specifications__specification font15 font-pri">.520 kg</span>
                        </li>
                        <li class="specifications__item">
                            <span class="specifications__name font15 font-pri">Dung tích thùng nhiên liệu</span>
                            <span class="specifications__specification font15 font-pri">70 L</span>
                        </li>
                        <li class="specifications__item">
                            <span class="specifications__name font15 font-pri">Số chỗ ngồi</span>
                            <span class="specifications__specification font15 font-pri">5</span>
                        </li>
                    </ul>
                    <div class="gray-line"></div>
                </div>
                <div class="deposit-price">
                    <h3 class="deposit-price__title font20 font-cond-bold">ĐẶT CỌC GIÁ BÁN LẺ</h3>
                    <span class="deposit-price__price font20 font-cond-bold">10,000,000đ</span>
                </div>
