...
use Platform\Car\Tables\CarCategoryTable;
use Platform\Base\Events\CreatedContentEvent;
use Platform\Base\Events\DeletedContentEvent;
use Platform\Base\Events\UpdatedContentEvent;
use Platform\Base\Http\Responses\BaseHttpResponse;
use Platform\Car\Forms\CarCategoryForm;
...
class CarCategoryController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('plugins/car::car-category.name'));
    ...
    {
        page_title()->setTitle(trans('plugins/car::car-category.create'));
    ...
    {
        $carCategory = $this->carCategoryRepository->createOrUpdate(array_merge($request->input(), [
            'author_id'   => Auth::id(),
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('plugins/car::car-category.edit') . ' "' . $carCategory->name . '"');
