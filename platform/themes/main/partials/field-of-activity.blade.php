        ...
        <div class="field-home-content">
            <div class="top">
                <div class="top-left hover-image-homepage" data-aos="fade-up" data-aos-duration="1200" data-aos-easing="ease-in-out" >
                    ...
                    <img loading="lazy" class="invisible-height-0  blue" src="{{ get_image_url(get_field($page,'homepage_production_logo_blue')) }}" alt="{{get_field($page, 'homepage_production_title')}}">
                ...
                <div class="top-right">
                    <div class="top-right-item hover-image-homepage" data-aos="zoom-in" data-aos-duration="1200" data-aos-easing="ease-in-out">
                        ...
                        <img loading="lazy" class="invisible-height-0  blue" src="{{ get_image_url(get_field($page,'homepage_production_block_1_logo_blue')) }}" alt="{{get_field($page, 'homepage_production_block_1')}}">
                    ...
                    <div class="top-right-item hover-image-homepage" data-aos="zoom-in" data-aos-duration="1200" data-aos-easing="ease-in-out">
                        ...
                        <img loading="lazy" class="invisible-height-0  blue"  src="{{ get_image_url(get_field($page,'homepage_production_block_2_logo_blue')) }}" alt="{{get_field($page, 'homepage_production_block_2')}}">
                    ...
                    <div class="top-right-item hover-image-homepage" data-aos="zoom-in" data-aos-duration="1200" data-aos-easing="ease-in-out">
                        ...
                        <img loading="lazy" class="invisible-height-0  blue" src="{{ get_image_url(get_field($page,'homepage_production_block_3_logo_blue')) }}" alt="{{get_field($page, 'homepage_production_block_3')}}">
                    ...
                    <div class="top-right-item hover-image-homepage" data-aos="zoom-in" data-aos-duration="1200" data-aos-easing="ease-in-out">
                        ...
                        <img loading="lazy" class="invisible-height-0  blue" src="{{ get_image_url(get_field($page,'homepage_production_block_4_logo_blue')) }}" alt="{{get_field($page, 'homepage_production_block_4')}}">
            ...
            <div class="bottom">
                <div class="bottom-left hover-image-homepage" data-aos="fade-down" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    ...
                    <img loading="lazy" class="invisible-height-0  blue" src="{{ get_image_url(get_field($page,'homepage_business_logo_blue')) }}" alt="{{get_field($page, 'homepage_business_title')}}">
                    <p class="name-img font-pri-bold font18 color-pri fontmb-small">THACO AUTO</p>
                ...
                <div class="bottom-right">
                    <div class="bottom-right-item hover-image-homepage" data-aos="zoom-in" data-aos-duration="1200" data-aos-easing="ease-in-out">
                            ...
                            <img loading="lazy" class="invisible-height-0  blue" src="{{ get_image_url(get_field($page,'homepage_business_block_1_logo_blue')) }}" alt="{{get_field($page, 'homepage_business_block_1')}}">
                    ...
                    <div class="bottom-right-item hover-image-homepage" data-aos="zoom-in" data-aos-duration="1200" data-aos-easing="ease-in-out">
                            ...
                            <img loading="lazy" class="invisible-height-0  blue" src="{{ get_image_url(get_field($page,'homepage_business_block_2_logo_blue')) }}" alt="{{get_field($page, 'homepage_business_block_2')}}">
                    ...
                    <div class="bottom-right-item hover-image-homepage" data-aos="zoom-in" data-aos-duration="1200" data-aos-easing="ease-in-out">
                            ...
                            <img loading="lazy" class="invisible-height-0  blue" src="{{ get_image_url(get_field($page,'homepage_business_block_3_logo_blue')) }}" alt="{{get_field($page, 'homepage_business_block_3')}}">
                    ...
                    <div class="bottom-right-item hover-image-homepage" data-aos="zoom-in" data-aos-duration="1200" data-aos-easing="ease-in-out">
                            ...
                            <img loading="lazy" class="invisible-height-0  blue" src="{{ get_image_url(get_field($page,'homepage_business_block_4_logo_blue')) }}" alt="{{get_field($page, 'homepage_business_block_4')}}">
                    ...
                    <div class="bottom-right-item hover-image-homepage" data-aos="zoom-in" data-aos-duration="1200" data-aos-easing="ease-in-out">
                            ...
                            <img loading="lazy" class="invisible-height-0  blue" src="{{ get_image_url(get_field($page,'homepage_business_block_5_logo_blue')) }}" alt="{{get_field($page, 'homepage_business_block_5')}}">
