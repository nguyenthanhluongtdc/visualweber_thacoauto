...
<div class="section-support-industry-overview">
    <div class="container-remake">
        <div class="mechandical-overview mt-60 mb-60">
            <h2 class="mechandical-overview__title font60 font-pri-bold">CÔNG NGHIỆP HỖ TRỢ</h2>
            ...
            <div class="mechandical-overview__boxfield">
               ...
               <div class="boxfield-item">
                ...
                <div class="boxfield-item">
                    ...
                    <p class="font24 font-pri-bold name">LINH KIỆN XE MÁY<br>
                        Ô TÔ</p>
                </div>
                <div class="boxfield-item">
                    <img src="{{ Theme::asset()->url('images/support-industry/sanpham-phutro.png') }}" alt="">
                    <p class="font24 font-pri-bold name">SẢN PHẨM PHỤ TRỢ</p>
                </div>
...
<div class="section-support-industry-overview-mobile">
    <div class="container-remake">
        <div class="mechandical-overview mt-60 mb-60">
            <h2 class="mechandical-overview__title fontmb-large font-pri-bold">CÔNG NGHIỆP HỖ TRỢ</h2>
