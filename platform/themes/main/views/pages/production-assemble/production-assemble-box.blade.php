        ...
        <ul class="pagination-customize" >
            <li class="pagi-item" >
                ...
                <a href="#section_one" title="" class="number2 click_scroll">
                    <img src="{{ Theme::asset()->url('images/manufacturing/white/1.png') }}" alt="">
                </a>
            ...
            <li class="pagi-item">
                ...
                <a href="#section_one" title="" class="number2 click_scroll">
                    <img src="{{ Theme::asset()->url('images/manufacturing/white/3.png') }}" alt="">
                </a>
            </li>
            ...
            <li class="pagi-item">
                ...
                <a href="#section_one" title="" class="number2 click_scroll">
                    <img src="{{ Theme::asset()->url('images/manufacturing/white/4.png') }}" alt="">
                </a>
            </li>
            ...
            <li class="pagi-item">
                ...
                <a href="#section_one" title="" class="number2 click_scroll">
                    <img src="{{ Theme::asset()->url('images/manufacturing/white/5.png') }}" alt="">
                </a>
            </li>
            ...
            <li class="pagi-item">
                ...
                <a href="#section_one" title="" class="number2 click_scroll">
                    <img src="{{ Theme::asset()->url('images/manufacturing/white/6.png') }}" alt="">
                </a>
            </li>
        </ul>
    </div>
