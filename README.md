...
git clone ssh://git@git.visualweber.net:1506/viweb-dev/thacoauto.git -b develop
cd /home/dev/htdocs/thacoauto/
touch README.md
git add README.md
...
cd /home/dev/htdocs/thacoauto/
git init
git remote add origin ssh://git@git.visualweber.net:1506/viweb-dev/thacoauto.git
git fetch --all
...
```
<VirtualHost *:80>
    ServerAdmin admin@thacoauto.dev.gistensal.com
    ServerName thacoauto.dev.gistensal.com
    ServerAlias www.thacoauto.dev.gistensal.com
    SetEnv APPLICATION_ENV "development"
    SetEnv ENVIRONMENT "development"
    SetEnv ENV "development"

    ErrorLog "/home/dev/logs/thacoauto-error_log"
    DocumentRoot "/home/dev/htdocs/thacoauto/"
    <Directory "/home/dev/htdocs/thacoauto/">
...
##### Domain: http://thacoauto.dev.gistensal.com or https://thacoauto.dev.gistensal.com
...
`/home/dev/htdocs/thacoauto/`

Just run this file, then you will have the delivery files

```
$ bash /home/dev/htdocs/thacoauto/bin/delivery.sh
```

- http://thacoauto.dev.gistensal.com/thacoauto.zip 
- http://thacoauto.dev.gistensal.com/thacoauto.sql 
- Done!
...
- Mysql DB Name: dev_thacoauto
- Mysql DB User: userdb.dev.thacoauto
- Mysql DB Password: QA2n14vHG8I3Spwz
```
##### MongoDB Database:

```
- Mongo DB Name: dev_thacoauto
- Mongo DB User: userdb.dev.thacoauto
- Mongo DB Password: QA2n14vHG8I3Spwz
```
...
```
/usr/bin/certbot delete --cert-name thacoauto.dev.gistensal.com
```
...
```
sudo certbot --authenticator standalone --installer nginx -d thacoauto.dev.gistensal.com -d www.thacoauto.dev.gistensal.com --pre-hook "service nginx stop" --post-hook "service nginx start"
```
...
IMPORTANT NOTES:
 - Congratulations! Your certificate and chain have been saved at
   /etc/letsencrypt/live/thacoauto.dev.gistensal.com/fullchain.pem. Your cert will
...
```
zip -r thacoauto.zip . -x \*.buildpath/\* \*.idea/\* \*.project/\* \*nbproject/\* \*.git/\* \*.svn/\* \*.gitignore\* \*.gitattributes\* \*.md \*.MD \*.log \*.zip \*.tar.gz \*.gz \*.tar \*.rar \*.DS_Store \*.lock \*desktop.ini vhost-nginx.conf \*.tmp \*.bat bin/delivery.sh bin/remove-botble.sh readme.html composer.lock wp-config.secure.php

-- without symlink
zip -r4uy thacoauto.zip . -x \*.buildpath/\* \*.idea/\* \*.project/\* \*nbproject/\* \*.git/\* \*.svn/\* \*.gitignore\* \*.gitattributes\* \*.md \*.MD \*.log \*.zip \*.tar.gz \*.gz \*.tar \*.rar \*.DS_Store \*.lock \*desktop.ini vhost-nginx.conf \*.tmp \*.bat bin/delivery.sh bin/remove-botble.sh readme.html composer.lock wp-config.secure.php
```
...
```
mysqldump  -hlocalhost -uuserdb.dev.thacoauto -pQA2n14vHG8I3Spwz dev_thacoauto > dev_thacoauto.sql
mysqldump  -uuserdb.dev.thacoauto -p dev_thacoauto > dev_thacoauto.sql
mysqldump  -uuserdb.dev.thacoauto -pQA2n14vHG8I3Spwz dev_thacoauto | gzip -9 > dev_thacoauto.sql.gz
mysqldump  -uuserdb.dev.thacoauto -pQA2n14vHG8I3Spwz --default-character-set utf8 dev_thacoauto  > dev_thacoauto.mysql
```

* Restoring your MySQL Database

```
mysql -uuserdb.dev.thacoauto -pQA2n14vHG8I3Spwz dev_thacoauto < dev_thacoauto.sql
mysql -h127.0.0.1 -uuserdb.dev.thacoauto -pQA2n14vHG8I3Spwz --default-character-set utf8 dev_thacoauto < dev_thacoauto.sql


If you need to restore a database that already exists, you'll need to use mysqlimport command. The syntax for mysqlimport is as follows
mysqlimport -uuserdb.dev.thacoauto -pQA2n14vHG8I3Spwz dev_thacoauto < dev_thacoauto.sql

To restore compressed backup files you can do the following:
gunzip < dev_thacoauto.sql.gz | mysql -uuserdb.dev.thacoauto -pQA2n14vHG8I3Spwz dev_thacoauto

Restore from FILE:
mysql.exe --defaults-file="c:\users\anonym~1\appdata\local\temp\tmpn3ytli.cnf"  --protocol=tcp --host=127.0.0.1 --user=userdb.dev.thacoauto --port=3306 --default-character-set=utf8 --comments  < "E:\\dev_thacoauto.sql"
...
FROM information_schema.COLUMNS WHERE TABLE_SCHEMA = dev_thacoauto;
```
...
sudo mongodump --host localhost:27017 -u userdb.dev.thacoauto -p QA2n14vHG8I3Spwz --db dev_thacoauto --out mongodb-2017-04-09.json
```

* Restore your MongoDB Database

```
sudo mongorestore --host localhost:27017 -u userdb.dev.thacoauto -p QA2n14vHG8I3Spwz --db dev_thacoauto --drop /home/jobsin/mongodb-2017-04-09.json/dev_thacoauto
```
...
$ use dev_thacoauto
$ db.createUser( { user: "userdb.dev.thacoauto",pwd: "QA2n14vHG8I3Spwz",roles: [ {role:"readWrite",db:"dev_thacoauto"}] } )
```
