        ...
        <div class="container-remake ">
            <div class="mechanical-tab__content pt-60 pb-60" data-aos="fade-up" data-aos-duration="1500" data-aos-easing="ease-in-out" data-aos-delay="50" >
                <div class="list-group tab-field" id="list-tab" role="tablist" >
                    <a class="list-group-item active show font30" id="field_name_1" data-toggle="list" href="#field_tab_content_1" role="tab" aria-controls="home" aria-selected="false">GIA CÔNG THÉP</a>
                    <a class="list-group-item font30 " id="field_name_2" data-toggle="list" href="#field_tab_content_2" role="tab" aria-controls="profile" aria-selected="true">TỔ HỢP CƠ KHÍ</a>
                    <a class="list-group-item font30 " id="field_name_3" data-toggle="list" href="#field_tab_content_3" role="tab" aria-controls="home" aria-selected="false">NHÀ MÁY THÉP</a>
                    <a class="list-group-item font30 " id="field_name_4" data-toggle="list" href="#field_tab_content_4" role="tab" aria-controls="profile" aria-selected="true">NHÀ MÁY NHÍP Ô TÔ</a>
                    <a class="list-group-item font30 " id="field_name_5" data-toggle="list" href="#field_tab_content_5" role="tab" aria-controls="home" aria-selected="false">SẢN XUẤT KHUÔN</a>
                </div>
                <div class="tab-content" id="nav-tabContent tab-content2" >
                    <div class="tab-pane fade active show " id="field_tab_content_1" role="tabpanel" aria-labelledby="list-home-list">
                        <div class="content-right">
                            <div class="content-right__top">
                                <img loading="lazy" src="{{ Theme::asset()->url('images/mechandical/nhamaythep.jpg') }}" alt="">
                            </div>
                            ...
                            <div class="content-right__bottom">
                                ...
                                <p class="desc font15 ">Nhà máy Gia công và cung ứng phôi thép được thành lập vào năm 2009 với chức năng sản xuất các sản phẩm vật tư thép, kim loại màu nhằm cung cấp cho thị trường nội địa và xuất khẩu. Nhà máy có diện tích 5ha, tổng vốn đầu tư 201 tỷ đồng, công suất 255.000 tấn thép/năm.</p>
                               <div class="read-more font18"><a href="">Xem chi tiết</a></div>
                            </div>

                        </div>
                    </div>
                    <div class="tab-pane fade" id="field_tab_content_2" role="tabpanel" aria-labelledby="list-home-list">
                        <div class="content-right">
                            <div class="content-right__top">
                                <img loading="lazy" src="{{ Theme::asset()->url('images/mechandical/nhamaythep.jpg') }}" alt="">
                            </div>
                    ...
                    <div class="tab-pane fade" id="field_tab_content_3" role="tabpanel" aria-labelledby="list-home-list">
                        <div class="content-right">
                            <div class="content-right__top">
                                <img loading="lazy" src="{{ Theme::asset()->url('images/mechandical/nhamaythep.jpg') }}" alt="">
                            </div>
                    ...
                    <div class="tab-pane fade" id="field_tab_content_4" role="tabpanel" aria-labelledby="list-home-list">
                        <div class="content-right">
                            <div class="content-right__top">
                                <img loading="lazy" src="{{ Theme::asset()->url('images/mechandical/nhamaythep.jpg') }}" alt="">
                            </div>
    ...
    <div class="mechanical-tab-wrapper" style="background-image:url('{{ Theme::asset()->url('images/mechandical/bg-tab2.png') }}')">
        <div class="container-remake ">
            <div class="mechanical-tab__content row pt-60 pb-60" data-aos="fade-up" data-aos-duration="1500" data-aos-easing="ease-in-out" data-aos-delay="50" >
                ...
                <div class="tab-content col-md-12 p-0" id="nav-tabContent tab-content2" >
                    <div class="tab-pane fade active show " id="field_tab_content_6" role="tabpanel" aria-labelledby="list-home-list">
                        <div class="content-right">
                            <div class="content-right__top">
                                <img loading="lazy" src="{{ Theme::asset()->url('images/mechandical/nhamaythep.jpg') }}" alt="">
                            </div>
                    ...
                    <div class="tab-pane fade" id="field_tab_content_7" role="tabpanel" aria-labelledby="list-home-list">
                        <div class="content-right">
                            <div class="content-right__top">
                                <img loading="lazy" src="{{ Theme::asset()->url('images/mechandical/nhamaythep.jpg') }}" alt="">
                            </div>
