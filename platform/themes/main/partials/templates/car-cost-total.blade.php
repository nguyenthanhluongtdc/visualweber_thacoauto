            ...
            <div class="deposit__detail MyriadPro-Regular font15" id="accordion">
                ...
                <div class="card">
                    ...
                    <div id="collapse_expense" class="collapse show" aria-labelledby="heading_expense" data-parent="#accordion">
                        <div class="card-body">
                            <p class="">{{ __("Phí xe") }}</p>
                            <p class="">{{ $car->price ? number_format($car->price, 0, '.', ',') . 'đ' : '0đ' }}</p>
                            <p class="">{{ __("Phí trước bạ(10%)") }}</p>
                            <p class="">{{ $car->fee ? number_format($car->fee, 0, '.', ',') . 'đ' : '0đ' }}</p>
                            <p class="">{{ __('Phí đăng kiểm biển số') }}</p>
                            <p class="">{{ $car->fee_license_plate ? number_format($car->fee_license_plate, 0, '.', ',') . 'đ' : '0đ' }}</p>
                        </div>
                    </div>
                </div>
                <div class="card">
